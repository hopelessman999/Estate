...
<body>
	...
	<form action="<?php echo U();?>" method="post" class="form-horizontal">
		...
		<div class="form-item">
			<label class="item-label">内容<span class="check-tips">详细内容<span></label>
			<div class="controls textarea input-large">
				<textarea class="" name="content"><?php echo ((isset($info["content"]) && ($info["content"] !== ""))?($info["content"]):''); ?></textarea>
				<!--<input type="textarea" class="text input-large" name="url" value="<?php echo ((isset($info["url"]) && ($info["url"] !== ""))?($info["url"]):''); ?>">-->
			</div>
		</div>
        <!--<div class="form-item">-->
            <!--<label class="item-label">地址<span class="check-tips">（是否新窗口打开链接）</span></label>-->
            <!--<div class="controls">-->
                <!--<select name="target">-->
